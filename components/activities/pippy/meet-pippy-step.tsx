...
export function MeetPippyStep({ onNext }: MeetPippyStepProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center max-w-xl mx-auto gap-6">
      ...
      <div className="bg-brand-muted border border-brand rounded-2xl p-5 max-w-sm text-center">
        <p className="text-sm text-fg-muted mb-1 font-medium">Pippy is learning to recognize:</p>
      ...
      <div className="bg-fill border border-hairline rounded-xl p-4 text-sm text-fg-muted max-w-sm">
